""" Bajgle, autor: Al Sweigard, al@inventwithpython
Logiczna gra na dedukcję, gdzie musisz odganąć liczbęna podstawie wskazówek.
Kod pobrany ze strony: https://ftp.helion.pl/przykladywksma.zip

Inną wersję tej gry znajdzissz w książce 'Twórz własne gry komputerowe w Pythonie', 
...
NUM_DIGITS = 3  # (!) Spróbuje ustawić tę stałą na 1 lub 10.
...
def main():
    ...
    Mam na myśli {}-cyfrową liczbę, w której nie powtarza się żadna z cyfra.
    Spróbują ją odgadnąć. Oto wskazówki:
    Gdy mówię:      Oznacza to:
    Piko            Jedna cyfra jest poprawna, ale jest na złej pozycji.
    Fermi           Jedna cyfra jest poprawna i znajduje się w dobrym miejscu.
    Bajgle          Żadna cyfra nie jest poprawna.
    
    Na przykład, jeśli tajna liczba to 248, a Ty podajesz liczbę 843, 
    ...
    while True:  # Pętla główna
        ...
        while numGuesses <= MAX_GUESSES:
            ...
            if numGuesses > MAX_GUESSES:
                print('Wykorzystane zostały wszystkie próby.')
...
def getSecretNum():
    """Zwraca liczbę złożoną z tylu losowych unikatowych cyfr, ile wynosi
    wartość NUM_DIGITS."""
